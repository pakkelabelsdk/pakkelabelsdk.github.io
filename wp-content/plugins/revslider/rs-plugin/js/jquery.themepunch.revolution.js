...
********************************/
		...
		********************************/
		...
		var swapSlideProgress = function(container,opt) {
			...
			if (nextli.data('saveperformance')!="on") removetime = 0;

			setTimeout(function() {
				//opt.cd=0;
			    //container.trigger('nulltimer');
			    container.trigger('restarttimer');
				LayerAnimation(container,opt,nextli,actli,actsh,nextsh);
			},removetime)
		...
		*******************************************/
		...
		var LayerAnimation = function(container,opt,nextli,actli,actsh,nextsh) {
